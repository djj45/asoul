...
字体分为衬线字体（serif）和无衬线体（sans serif）。上图中左边是无衬线体，右边是衬线字体。中文字体中，宋体是衬线字体，黑体是无衬线体

可以免费商用的中文、英文、日文、韩文的衬线字体和无衬线体各一份我已经打包好了，也可以去官网下载

https://pan.baidu.com/s/1a-kfacU09U2e_HENkeZong        i24r

[思源黑体(Source Han Sans)](https://github.com/adobe-fonts/source-han-sans/releases)

用[GitHub加速下载网站](http://shrill-pond-3e81.hunsh.workers.dev/)下载不同语言的思源黑体的Subset版
...
打轴的要求来源于vtuber字幕组的规定，为了避免闪轴，前一个轴的结尾与后一个轴的开头间隔不能小于300ms（可以紧贴，即间隔为0ms），在多人轴中，如果甲说话的轴的结尾与乙说话的轴的结尾间隔小于300ms，要设置为同时结束（甲轴与乙轴结束时间一样），如果一句话语速很快，小于500ms，要延长到500ms，不然观众看不清字幕，字幕就消失了，如果是给歌曲打轴，轴的开始要紧贴开始唱的时间，轴的结束要稍微延长300ms左右，不要刚刚唱完字幕就消失，歌轴不考虑闪轴
